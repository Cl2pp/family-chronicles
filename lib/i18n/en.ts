...
export const en = {
  ...
  story: {
    ...
    removePhotoConfirmText: 'Remove this photo from the story? This cannot be undone.',
  ...
  books: {
    ...
    defaultBirthdayBookTitle: (chronicle: string) => `${chronicle} Birthday Book`,
    defaultPhotoBookTitle: (chronicle: string) => `The ${chronicle} Photo Book`,
    kindIntro: 'Choose a template and where you want to start.',
    kindStory: 'Story book',
    kindStoryHint: 'Start from your written stories — they become chapters. You can add photos later.',
    kindBirthday: 'Birthday Book',
    kindBirthdayHint:
      'Stories open on left-hand pages, followed by all their photos in collages, with a cover collage you choose.',
    kindPhoto: 'Photo book',
    kindPhotoHint: 'Start by uploading photos — we sort, clean up and lay them out. You can add stories later.',
    storyCount: (n: number) => (n === 1 ? '1 story' : `${n} stories`),
    ...
    builder: {
      ...
      photoBook: {
        ...
        stepUploadDescription: 'Choose stories and photos',
        ...
        sources: {
          ...
          photoCount: (n: number) => (n === 1 ? '1 photo' : `${n} photos`),
          uploadTitle: 'Uploaded photos',
          uploadHint: 'Photos you add here belong to this book only — they are not attached to any story.',
          needContent: 'Add at least one story or one photo to continue.',
        },
        preview: 'Preview',
        ...
        chat: {
          ...
          placeholder: 'What should change in your photo book?',
          send: 'Send',
          thinking: 'Working on it…',
          error: 'Sorry — that didn\'t work. Please try again.',
          recordVoiceAria: 'Record voice message',
          ...
          compressing: 'Compressing recording…',
          transcribing: 'Transcribing…',
          transcriptionFailed: 'Couldn\'t be transcribed. Please try again.',
          transcriptionTooLong: 'Sorry — that recording is too long to transcribe. Please try a shorter one.',
          voiceMessage: 'Voice message',
        },
      },
    },
    order: {
      ...
      orderSubmitting: 'Sending your order to the printer — this takes a moment…',
      stepPlaced: 'Order placed',
      stepSubmitted: 'Sent to the printer',
      stepSubmittedDraft: 'Waiting for your confirmation in the Gelato dashboard.',
      stepInProduction: 'In production',
      stepShipped: 'Shipped',
      stepDelivered: 'Delivered',
      orderTracking: 'Tracking',
      orderTrackOpen: 'Track the parcel',
      orderFailedTitle: 'Your order could not be sent to the printer.',
      ...
      createPrintFileCta: 'Create print file',
      addressTitle: 'Delivery address',
      fieldFirstName: 'First name',
      fieldLastName: 'Last name',
      fieldAddressLine1: 'Street and number',
      ...
      orderPaymentNote:
        'Ordering sends this book to our print partner Gelato. Payment is handled outside the app — nothing is charged here.',
      orderNoReturnsNote:
