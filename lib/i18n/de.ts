...
export const de: Dictionary = {
  ...
  books: {
    ...
    defaultBirthdayBookTitle: (chronicle: string) => `${chronicle} Geburtstagsbuch`,
    defaultPhotoBookTitle: (chronicle: string) => `Das ${chronicle}-Fotobuch`,
    kindIntro: 'Wähle eine Vorlage und womit du starten möchtest.',
    kindStory: 'Geschichtenbuch',
    kindStoryHint: 'Beginne mit euren geschriebenen Geschichten — sie werden zu Kapiteln. Fotos kannst du später ergänzen.',
    kindBirthday: 'Geburtstagsbuch',
    kindBirthdayHint:
      'Geschichten beginnen links und werden von all ihren Fotos als Collage gefolgt — mit einer Titelcollage, die du auswählst.',
    kindPhoto: 'Fotobuch',
    kindPhotoHint: 'Beginne mit Fotos — wir sortieren, räumen auf und layouten. Geschichten kannst du später ergänzen.',
    storyCount: (n: number) => (n === 1 ? '1 Geschichte' : `${n} Geschichten`),
    ...
    builder: {
      ...
      photoBook: {
        ...
        stepUploadDescription: 'Geschichten und Fotos zusammenstellen',
        ...
        sources: {
          ...
          includePhotos: 'Fotos',
          photoCount: (n: number) => (n === 1 ? '1 Foto' : `${n} Fotos`),
          uploadTitle: 'Hochgeladene Fotos',
          uploadHint: 'Fotos, die du hier hinzufügst, gehören nur zu diesem Buch — sie hängen an keiner Geschichte.',
          needContent: 'Füge mindestens eine Geschichte oder ein Foto hinzu, um fortzufahren.',
        },
        preview: 'Vorschau',
