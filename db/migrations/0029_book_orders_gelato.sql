...
ALTER TABLE "book_orders" ADD COLUMN "gelato_order_type" text;--> statement-breakpoint
...
ALTER TABLE "book_orders" ADD COLUMN "submit_started_at" timestamp;--> statement-breakpoint
...
CREATE UNIQUE INDEX "book_orders_open_uq" ON "book_orders" USING btree ("book_id") WHERE status NOT IN ('cancelled', 'failed');